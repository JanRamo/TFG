...
#loader = es.MonoLoader(filename = './audio/vco1_0.0_pul-con.wav', sampleRate = 44100)
pool = essentia.Pool()
...
awrite = es.MonoWriter (filename = './audio/vco1_0.0_pul-con_sine.wav', sampleRate =  params['sampleRate'])
